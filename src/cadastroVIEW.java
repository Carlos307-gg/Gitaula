    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        try {
            ...
            if (produtodao.cadastrarProduto(produto)) {
                ...
                JOptionPane.showMessageDialog(null, "Produto não pode ser cadastrado. Verifique os dados", "ERRO ao Cadastrar Produto", JOptionPane.ERROR_MESSAGE);
            }

        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(null, "Número inválido", "ERRO ao Cadastrar Valor do Produto", JOptionPane.ERROR_MESSAGE);
        }
